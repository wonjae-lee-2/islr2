...
mach_linear1 = machine(linear, X, y) |> fit!

# ╔═╡ de85f7d5-32e1-4054-915f-4ede898db823
evaluate!(mach_linear1, resampling = Holdout(fraction_train = 0.5, rng = 1), measure = rms)
...
mach_linear2 = machine(linear, X2, y) |> fit!

# ╔═╡ fd6c8b05-6512-40ae-a9a4-2b67f84366b7
evaluate!(mach_linear2, resampling = Holdout(; fraction_train = 0.5, rng = 2), measure = rms)
...
mach_linear3 = machine(linear, X3, y) |> fit!

# ╔═╡ 47e64892-93b1-454e-be88-1932df3c413e
evaluate!(mach_linear3, resampling = Holdout(; fraction_train = 0.5, rng = 3), measure = rms)

# ╔═╡ 00be707a-478d-4da7-a653-8907bb777178
function poly(dataframe, degree)
	result = DataFrames.copy(dataframe)
	for i in 2:degree
		DataFrames.transform!(result, :horsepower => DataFrames.ByRow(x -> x^i) => Symbol("horsepower", i))
	end
	return result
end

# ╔═╡ 80a1c454-7782-455c-945e-0388a065e078
for i in 1:10
	evaluate(linear, poly(X, i), y, resampling = CV(; nfolds = DataFrames.nrow(X), rng = 5), measure = rms)
end

# ╔═╡ db41366d-d279-4adf-ae66-717c4c12c5d6


# ╔═╡ eacc5b9d-97cd-4a52-abc0-373ed9e3bc3b


# ╔═╡ f464d85d-96fa-4b46-b171-8277679de13e


# ╔═╡ 74ced9b3-4ef9-4145-a606-e8f39f9072f0


# ╔═╡ bd2b61f6-ae4f-4028-bc2c-08b501fa67ef
