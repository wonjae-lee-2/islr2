...
# ╔═╡ 75595a82-8994-47c6-b224-275579164aba
data_folder = expanduser("~/github/islr2/data")

# ╔═╡ 62b498c2-72b2-4b8f-9aec-109fd975c037
md"""
## Exercise 2.8
"""

# ╔═╡ d7b5d96b-914a-4ca6-9c6f-0d80d10f3a5a
md"""
### Problem (b)
"""

# ╔═╡ 72707f8c-02b6-48d6-b232-b783e86e00c5
begin
	college = CSV.read(joinpath(data_folder, "College.csv"), DataFrame)
	rename!(college, :Column1 => :Rownames)
	college
end

# ╔═╡ 69fba346-b2fd-4be8-b04f-cda6d76ac0c0
md"""
### Problem (c)
"""

# ╔═╡ 19cde3b4-319f-4c4e-96fd-db3c2330949f
describe(college)

# ╔═╡ f1c2a965-954f-441c-be76-9c8a0085f6a8
describe(select(college, names(college, Number)))

# ╔═╡ 6a8bf73c-a75a-48bd-b4ef-9fc4269c67c5
describe(select(college, names(college, AbstractString)))
...
# ╔═╡ 70cca93f-a7b5-490d-929e-43d41f2d2060
begin
	auto = CSV.read(joinpath(data_folder, "Auto.csv"), DataFrame)
	describe(auto)
end

# ╔═╡ 585bcb08-655b-4e2c-93d2-62a464d91ee6
begin
	filter!(:horsepower => !=("?"), auto)
	auto[!, :horsepower] = parse.(Int, auto[:, :horsepower])
	describe(auto)
end

# ╔═╡ a097bd05-c828-4b17-984a-f6470d97f98f
md"""
### Problem (a)
"""

# ╔═╡ 9d1cabe6-42ae-442a-a41b-c612356e1feb
begin
	colql = ["origin", "name"]
	colqt = [x for x in names(auto) if !(x in colql)]
end

# ╔═╡ ce4a03fd-799e-4007-8de2-e845ce4f91e3
md"""
### Problem (b)
"""

# ╔═╡ bdd9a87d-4116-4144-8b77-08528e5beea0
autoqt = auto[:, Cols(colqt)]

# ╔═╡ be39ba40-7a61-4139-91d8-8314e6b6ea2d
describe(autoqt, (x -> maximum(x) - minimum(x)) => :range)

# ╔═╡ ac435815-0656-4c37-845f-df4d878b6ed1
md"""
### Problem (c)
"""

# ╔═╡ 3f3adaa8-997b-4400-a957-58490b5010ff
describe(autoqt, :mean, :std)

# ╔═╡ cde178d4-565d-44fa-8aee-01b912ed959b
md"""
### Problem (d)
"""

# ╔═╡ e472fd1c-f10a-4315-97d4-9d675a796a00
describe(autoqt, :mean, :std, (x -> maximum(x) - minimum(x)) => :range)
